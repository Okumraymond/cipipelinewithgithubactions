...
SVC_NAME="actions.runner.Okumraymond-cipipelinewithgithubactions.Admins-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Okumraymond-cipipelinewithgithubactions.Admins-MacBook-Pro)"
